...
def osd_sink_pad_buffer_probe(pad, info, u_data):
    ...
    while l_frame is not None:
        ...
        # Eric: The l object holds the metadata for the object detection list. The structure loops in a while loop until
        # l_object data is loaded
...
# Eric: We will need to scrape the args since that is being used to pass an mp4 file for object detection and we want
...
def main(args):
    ...
    pgie.set_property('config-file-path', "ds_trafficcamtest_config.txt")
    ...
    config.read('ds_trafficcamtest_config.txt')
    config.sections()
